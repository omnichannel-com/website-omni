        ...
        <div className="container text-textClr font-nunito flex flex-col gap-12">
          <div>
            <p className="text-lg font-normal">
              Find all information regarding our Privacy Policy. This policy outlines our ongoing obligations to you in respect of how we manage your Personal Information.
              <br/><br/>
              ...
              <br/><br/>
              <strong className="text-secondaryColor font-bold font-nunito text-2xl mb-4">What is Personal Information and why do we collect it?</strong>
              <br/>
              ...
              <br/><br/>
              <strong className="text-secondaryColor font-bold font-nunito text-2xl mb-4">Sensitive Information</strong>
              <br/>
              ...
              <ul className="list-disc ml-8">
                ...
                <li>For a secondary purpose that is directly related to the primary purpose, or</li>
                <li>With your consent; or where required or authorised by law.</li>
              </ul>
              <p>
              <br/>
              <strong className="text-secondaryColor font-bold font-nunito text-2xl mb-4">Third Parties</strong>
              <br/>
              Where reasonable and practicable to do so, we will collect your Personal Information only from you. However, in some circumstances we may be provided with information by third parties. In such a case we will take reasonable steps to ensure that you are made aware of the information provided to us by the third party.
              <br/><br/>
              <strong className="text-secondaryColor font-bold font-nunito text-2xl mb-4">Disclosure of Personal Information</strong>
              <br/>
              ...
              <br/><br/>
              Your Personal Information may also be disclosed in a number of circumstances including the following:
              <ul className="list-disc ml-8">
                <li>To third parties where you consent to the use or disclosure; and</li>
                <li>Where required or authorised by law.</li>
              </ul>
              <br/>
              <strong className="text-secondaryColor font-bold font-nunito text-2xl mb-4">Security of Personal Information</strong>
              <br/>
              Your Personal Information is stored in a manner that reasonably protects it from misuse and loss and from unauthorised access, modification or disclosure.
              <br/><br/>
              When your Personal Information is no longer needed for the purpose for which it was obtained, we will take reasonable steps to destroy or permanently de-identify your Personal Information. However, most of the Personal Information is or will be stored in client files which will be kept by us for a minimum of 7 years.
              <br/><br/>
              <strong className="text-secondaryColor font-bold font-nunito text-2xl mb-4">Access to your Personal Information</strong>
              <br/>
              You may access the Personal Information we hold about you and to update and/or correct it, subject to certain exceptions. If you wish to access your Personal Information, please contact us in writing.
              <br/><br/>
              2ai will not charge any fee for your access request, but may charge an administrative fee for providing a copy of your Personal Information.
              <br/><br/>
              In order to protect your Personal Information we may require identification from you before releasing the requested information.
              <br/><br/>
              <strong className="text-secondaryColor font-bold font-nunito text-2xl mb-4">Maintaining the Quality of your Personal Information</strong>
              <br/>
              It is important to us that your Personal Information is up to date. We will take reasonable steps to make sure that your Personal Information is accurate, complete and up-to-date. If you find that the information we have is not up to date or is inaccurate, please advise us as soon as practicable so we can update our records and ensure we can continue to provide quality services to you.
              <br/><br/>
              <strong className="text-secondaryColor font-bold font-nunito text-2xl mb-4">Business Transfer</strong>
              <br/>
              ...
              <br/><br/>
              <strong className="text-secondaryColor font-bold font-nunito text-2xl mb-4">Government and Legal Disclosures</strong>
              <br/>
              We may disclose the personal information we collect through this Site, when we, in good faith, believe disclosure is appropriate to comply with the law (or a court order or subpoena); to prevent or investigate a possible crime, such as fraud or identity theft; to enforce our Terms and Conditions or other agreements that govern your use of this Site; or to protect the rights, property or safety of our company, our users, or others.
              <br/><br/>
              <strong className="text-secondaryColor font-bold font-nunito text-2xl mb-4">Cookies</strong>
              <br/>
              ...
              <br/><br/>
              <strong className="text-secondaryColor font-bold font-nunito text-2xl mb-4">Remember The Risks Whenever You Use The Internet</strong>
              <br/>
              ...
              <br/><br/>
              <strong className="text-secondaryColor font-bold font-nunito text-2xl mb-4">Policy Updates</strong>
              <br/>
              This Policy may change from time to time and is available on our website.
              <br/><br/>
              <strong className="text-secondaryColor font-bold font-nunito text-2xl mb-4">Privacy Policy Complaints and Enquiries</strong>
              <br/>
