  ...
  return (
    ...
    <SecondaryNavbar setISticky={isSticky} />
        ...
        <div className="container text-textClr font-nunito flex flex-col gap-12">
            <div>
                <p className="text-lg font-normal">These terms and conditions (Terms) govern your membership with 2ai, a product described on our Website here www.2ai.cx (Subscription). Your Subscription is for the tiered package as selected by you and agreed between us by means of the Website (Subscription Tier).
<br/>By clicking the tick box below, paying for your Subscription or otherwise accepting the benefit of any part of the Solution, you agree to be bound by these Terms which form a binding contractual agreement between you or the company you represent (the ‘Client’, or ‘you’) and 2ai Pty Ltd an Australian business with ABN 18 665 527 480 trading as 2ai (‘2ai, ‘our’, ‘we’ or ‘us’). You represent and warrant that you have valid authority to enter into these Terms on behalf of any entity you may represent.
...
<br/><br/>
            ...
            <div>
      <h1 className="text-secondaryColor font-bold font-nunito text-2xl mb-4">
    ...
    <div>
      ...
      <div className="text-lg font-normal space-y-4">
        ...
        <p>
          <strong>(c)</strong> By agreeing to these Terms, you agree to be bound by our <Link href="/privacy-policy" className="text-secondaryColor underline">Privacy Policy</Link>.
        </p>
      </div>
    </div>
    ...
    <div>
      ...
      <h1 className="text-secondaryColor font-bold font-nunito text-2xl mb-4 mt-8">
      ...
      <div className="text-lg font-normal space-y-4">
        ...
        <ul className="list-disc list-inside ml-6">
          ...
          <li>not to use the Software for any purposes other than the purpose of the Software, which is to build and deploy AI alteregos, to be used by Users (Purpose);</li>
    ...
    <div>
      ...
      <div className="text-lg font-normal space-y-4">
        ...
        <ul className="list-disc list-inside ml-6">
          ...
          <li>you agree to indemnify 2ai in relation to any loss or damage that may arise in relation to your complaint, including in relation to any third party claim that the complaint contains a groundless threat.</li>
        </ul>
      </div>
