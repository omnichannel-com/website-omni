  ...
  const faqs = [
    {
      ...
      answer: 'omnichannel CX specializes in training AI bots to perform like professional accountants, lawyers, instructors, and more. Our technology automates routine tasks, freeing up your time to focus on strategic initiatives and business growth.',
    },
    {
  ...
  return (
    <section className="scroll-section-1 bg-ocx-bg z-10 relative">
      <div className="container mx-auto py-10 md:py-20 flex flex-col gap-6 justify-center items-center">
        ...
        <div className="rounded-xl mt-8 bg-gradient-to-t from-ocx-bg-subtle to-ocx-bg backdrop-blur-md shadow-lg border w-full md:w-3/4 lg:w-2/3 px-4 md:px-8 py-4">
          {faqs.map((faq, index) => (
