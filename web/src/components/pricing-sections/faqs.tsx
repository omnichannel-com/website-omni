...
const FAQS = [
  {
    question: "How can omnichannel CX help my organisation?",
    answer:
      "We diagnose gaps across your customer experience and service operations, then build a practical plan to close them. This usually means higher satisfaction, lower cost to serve, and safe AI adoption that keeps your people in control.",
  },
  {
