...
- Name: brand.spec.ts >> Brand Consistency >> page /disclaimer has no old brand references
- Location: e2e/brand.spec.ts:8:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/disclaimer
Call log:
  - navigating to "http://localhost:3000/disclaimer", waiting until "load"
